function [dfilter1,dfilter2,dfilter3,dw1,dw2,dbias1,dbias2,dbias3,db1,db2] = mbgd_backward(image,p,label,max_pool_1,max_index_1,filter2,max_pool_2,max_index_2,filter3,c3,w1,w2,z1,a1)
addpath('./math');
#softmax层梯度
db2 = p;
...
for i = 1 : 20,
    ...
    #for j = 1 : 1,
    dfilter1(:,:,1,i) = dfilter1(:,:,1,i) .+ convn(image,dc1(:,:,i),'valid');
    #end;
end;