...
function [c1,max_pool_1,max_index_1,c2,max_pool_2,max_index_2,c3,z1,a1,z2,p,loss] = mbgd_forward(image,filter1,filter2,filter3,w1,w2,bias1,bias2,bias3,b1,b2,label)

#计算卷积层1
for i = 1:20,
  c1(:,:,i) = max(0,convn(image,filter1(:,:,:,i),'valid') .+ bias1(i,1));
